...
uv pip install --extra-index-url https://pypi.org/simple decord2
...
uv pip install --extra-index-url https://pypi.org/simple /opt/cosmos1-diffusion-renderer/wheels/nvidia_cosmos*.whl
