...
uv pip install --extra-index-url https://pypi.org/simple packaging
...
uv pip install --extra-index-url https://pypi.org/simple 'setuptools>=64' 'setuptools_scm>=8'
MAX_JOBS="$(nproc)" \
...
uv pip install --extra-index-url https://pypi.org/simple /opt/paraattention/wheels/para_attn*.whl
