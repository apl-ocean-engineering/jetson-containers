...
cd /opt/jax/wheels/
uv pip install --extra-index-url https://pypi.org/simple jaxlib*.whl jax_cuda13_plugin*.whl jax_cuda13_pjrt*.whl opt_einsum
uv pip install --extra-index-url https://pypi.org/simple jax
cd /opt/jax
