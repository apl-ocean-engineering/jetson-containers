...
uv pip install --extra-index-url https://pypi.org/simple -r install_requirements.txt
python3 setup.py --verbose bdist_wheel --dist-dir /opt

# install/upload wheels
uv pip install --extra-index-url https://pypi.org/simple --force-reinstall /opt/ctranslate2*.whl
