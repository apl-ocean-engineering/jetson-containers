...
cd /opt/pytorch3d
uv pip install --extra-index-url https://pypi.org/simple scikit-image matplotlib imageio plotly opencv-contrib-python
...
uv pip install --extra-index-url https://pypi.org/simple /opt/pytorch3d*.whl
