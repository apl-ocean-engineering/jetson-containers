...
uv pip install --extra-index-url https://pypi.org/simple /opt/videollama/wheels/videollama*.whl

uv pip install --extra-index-url https://pypi.org/simple --force-reinstall "transformers<=4.52"
