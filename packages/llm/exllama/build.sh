...
uv pip install --extra-index-url https://pypi.org/simple -U -r requirements_examples.txt
...
uv pip install --extra-index-url https://pypi.org/simple /opt/exllamav3*.whl
